...
$(document).ready(function () {
    ...
    $(".comment-add").live("focus", function () {
        $(this).siblings(".hidden-field").slideDown(); 
    });
    ...
    $(".comment-submit").live("submit", function (event) {
        ...
        comment_name = $(this).find("[name=comment-name]").val();
        comment_email = $(this).find("[name=comment-email]").val();
