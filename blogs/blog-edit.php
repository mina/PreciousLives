    ...
    <div class='row-fluid'>
      ...
      <div class='row-fuild update-title-form'>
        <form>
          ...
          <input type='text' value='<?=htmlspecialchars($blog['blogname']); ?>' id='edited_blogname' name='edited_blogname'/>
          <div class='row-fluid'>
        ...
        <div class='row-fluid'>
          ...
          <div class='span6'>
            ...
            <a href=<?php htmlspecialchars($blog['blogurl']); ?>>
        ...
        <table class='table-bordered table table-stripped'>
          ...
          <?php while ($post= mysql_fetch_array($posts)) : ?>
            <tr post_id=<?=$post['id']?>>
              ...
              <td><?=htmlspecialchars($post['time_stamp']); ?></td>
              <td>
