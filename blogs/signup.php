          ...
          <form class='signup-form' method='post' action='blog-edit.php'>
            <table class="input-table">
              <tr>
                ...
                <td>We'll say hi when you log in :)</td>
              </tr>
              <tr>
                <td>Blog's Name:</td>
                <td>
                  <input id='signup_blogname' name="signup_blogname" type="text" />
                </td>
                <td>This will be visible on your blog.</td>
              </tr>
              <tr>
                <td>Username:</td>
                <td>
                ...
                <td>You will use this to log in.</td>
              </tr>
              <tr>
                <td>Password:</td>
                <td>
                  <input id='password_one' type="password" name="signup_password" />
                </td>
                <td>You will use this too to log in.</td>
              </tr>
              <tr>
                <td>Repeat Password:</td>
                <td>
                  <input id='password_two' type="password" name="signup_password2" />
                </td>
              </tr>
              <tr>
                <td>www.preciouslives.net/blogs/</td>
                <td>
                  <input id="blog_url" type="text" name="blog_url" />
                </td>
                <td>Your blog will be hosted at this URL.</td>
              </tr>
              <tr>
